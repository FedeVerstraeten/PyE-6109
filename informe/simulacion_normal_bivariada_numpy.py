...
var2 = 1.0
#rho = 0.8
rho = (100+93)/200     # AGREGADO POR PABLO J. GONZÁLEZ
...
##################
# EXPORTACION DE DATOS DE LAS SIMULACIONES # AGREGADO POR PABLO J. GONZÁLEZ
...
pl.xlim(-3., 3.)
figura2.show()
#figura2.savefig('foo2.png')    # AGREGADO POR PABLO J. GONZÁLEZ    
...
pl.title('n_sim = '+str(n_sim))
figura4.show()
#figura4.savefig('foo4.png')    # AGREGADO POR PABLO J. GONZÁLEZ
...
figura5.show()
figura5.savefig('foo5_test.png')    # AGREGADO POR PABLO J. GONZÁLEZ
